...
public class Test_03_Iframes {
    ...
    public void iframeWithIdAndWebelement(){
        ...
        // parent frame e geçiş
        driver.switchTo().parentFrame(); // ya da defaultContent kullanabiliriz
    ...
    public void iframeWithIndex() {
        ...
        System.out.println(driver.findElement(By.tagName("h1")).getText());
        // parent frame e geçiş
        driver.switchTo().defaultContent(); // ya da defaultContent kullanabiliriz
        WebElement secondFrame = driver.findElement(By.xpath("//iframe[@src='frames/frames-header.html']"));
    ...
    public void nestedFrames() {
        ...
        // frameset frame değildir indexlerde dikkate alınmaz
